...
header='''desc:AB_ReaLayer (0.11.1)
...
meta+='// @about\n//   Four-layer random variation sampler for REAPER.\n//   Drop mono/stereo WAVs, detect individual sounds, and trigger variations with MIDI or Play Sampler.\n//   Includes per-layer mix, pitch, reverse chance, random amounts and envelopes, plus Randomise All and Chaos.\n//   Preallocates about 770 MiB per instance. WAV files remain external.\n// @changelog\n'
